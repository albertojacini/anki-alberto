#!/usr/bin/env python3
"""
Reads cards_643.json (with audio hashes already embedded) and uploads all cards
to Anki via AnkiConnect HTTP API directly (bypassing MCP for batch efficiency).
"""
...
DECK_NAME = "643: Eine Frage des Erwartungsmanagements"
...
def main():
    ...
    for i, card in enumerate(cards):
        ...
        tags = [f"deutsch::643-ErwartungsManagement", wortart]
